...
3. bash -c "$(wget -qO - 'https://raw.githubusercontent.com/MahirMandala/watchpingloop-updated/main/install.sh')" && chmod +x /usr/bin/watchpingloop.sh
4. lakukan edit file di /usr/bin/watchpingloop.sh . Edit Variable sesuai dengan kebutuhan anda.
